...
# Step 3: Select 20 samples with a 1:1 balance between recommended and not recommended
recommended = data[data["Recommended IND"] == 1]
not_recommended = data[data["Recommended IND"] == 0]
recommended_sample = recommended.sample(n=10, random_state=20)
not_recommended_sample = not_recommended.sample(n=10, random_state=20)
